...
/**
 * This is a bog-standard bubble sort.
 * It's super efficent!
 *
...
// also, if the optimizier is sufficently clever (which it probably isnt),
...
// would be unlikley: but it is legal, since our observed results (other than
